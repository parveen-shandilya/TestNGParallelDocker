...
public class CategoryPage extends Helper {
	...
	public static String addFieldLink1 = "(//a[text()='Add Field'])[1]";
	...
	// public static String categoriesCountHeader =
	// "//div[@class='agency-setup-tab__section__header']/h2";
	...
	public static By AddFieldLink1 = By.xpath(addFieldLink1);
	...
	public static By labelInputCustomFields = By.xpath("(//input[@placeholder='Enter Text'])[2]");
	...
	public static By requiredToggleYes = By.xpath("(//button[@class='square-btn btn btn-default'])[7]");
	...
	public static By closeButtonSecondaryCustomField = By
			.xpath("//div[@class='parent-of-subcategory']//div[@class='button-right-align']//button");
	public static By labelFieldValidationMessage = By
			.xpath("(//span[contains(@class,'field__error')][normalize-space()='The Label is required.'])[1]");
	public static By primaryQuestionValidationMessage = By
			.xpath("(//span[normalize-space()='Picklist type should have options'])[1]");
	public static By primaryQuestionLabelTextValidationMessage = By
			.xpath("(//span[contains(@class,'field__error')][normalize-space()='The Label is required.'])[2]");
	public static By labelFieldValidationMessageSecondaryCustom = By
			.xpath("(//span[contains(@class,'field__error')][normalize-space()='The Label is required.'])[3]");
	public static By addSecondSecondaryField = By.xpath("(//a[@class='category-modal__custom-fields-add'])[1]");
	public static By typeDropdown = By.xpath("//div[contains(@class,'Select-value')]");
	public static By typeDropdownForPicklist = By.xpath("(//div[contains(@class,'Select-value')])[6]");
	...
	public static By primaryOptionsDropdown5 = By.xpath("((//div[contains(text(),'Select Option')])[3])//..");
	...
	public static String editCategorysIcon = "((//div[text()='%s'])//..//..)//button";
	...
	public static By pickListDropdownText = By.xpath("//div[text()='Picklist']");
	public static By addValueOnManagePickListPopup = By.xpath("//a[text()='Add Value']");
	public static By pickListOption = By.xpath("//input[@name='option']");
	public static By pickListOption2 = By.xpath("(//input[@name='option'])[2]");
	public static By saveBtnOnManagePicklist = By.xpath("//button[@class='square-btn btn btn-primary'][text()='Save']");
	public static By labelFieldSecondaryCustomField5 = By.xpath("(//input[@name='label'])[3]");
	public static By labelFieldSecondaryCustomField6 = By.xpath("(//input[@name='label'])[4]");
	public static By nameFieldSeondaryCustom3 = By.xpath("(//input[@name='name'])[3]");
	public static By nameFieldSeondaryCustom5 = By.xpath("(//input[@name='name'])[5]");
	...
	public static By dropdownCategoryCSPExternal = By
			.xpath("//h2[contains(text(),'Category')]//parent::div//div[@class='dropdown__label']");
	public static By searchCategoryCSPExternal = By
			.xpath("//div[@class='dropdown-content__search-container']//input[@type='text']");
	...
	public static By requiredSecondaryCustomFields = By
			.xpath("(//div[@class='field__input row']//button[text()='Yes'])[4]");
	public static By requiredSecondaryCategoryCustomFields2 = By
			.xpath("(//div[@class='field__input row']//button[text()='Yes'])[6]");
	...
	public static String requiredCustomYesToggle = "(//div[@class='field__input row']//button[text()='Yes'])[%s]";
	...
	public int getCategoryCount() {
		waitForPresenceandVisiblity(CategoriesCountHeader);
	...
	public void clickOnTypeDropdownForPicklist() {
		waitForElementIsInteractable(typeDropdownForPicklist);
		clickByJsExecuter(typeDropdownForPicklist);
	}
	...
	public void clicOnEditCategoryActive() throws InterruptedException {
		scrollIntoView(EditCategoryIcon2);
		waitUntilElementIsVisible(EditCategoryIcon2);
	...
	public int getActiveHeaderCount() throws InterruptedException {
		forcedWaitTime(4);
		waitForPresenceandVisiblity(ActiveViolationCount);
